...
class UploadFile(Greenlet):
    ...
    def upload_to_doc_service(self):
        ...
        while not self.exit:
            try:
                ...
                continue
            try:
                response = self.doc_service_client.upload('edr_information.yaml', create_file(tender_data.file_content), 'application/yaml',
    ...
    def client_upload_to_doc_service(self, tender_data):
        ...
        return self.doc_service_client.upload('edr_information.yaml', create_file(tender_data.file_content), 'application/yaml',
