...
class TestFilterWorker(unittest.TestCase):
    ...
    def test_worker_qualification(self, gevent_sleep):
        ...
        worker = FilterTenders.spawn(client, filtered_tender_ids_queue, edrpou_codes_queue, processing_items, MagicMock())
    ...
    def test_worker_award(self, gevent_sleep):
        ...
        worker = FilterTenders.spawn(client, filtered_tender_ids_queue, edrpou_codes_queue, processing_items, MagicMock(), 2, 1)
